<div class="bg-custom1 p-2 rounded-2">
  ...
  <form wire:submit.prevent='store' >
    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="row border border-4 border-info rounded shadow py-4">
          ...
          <div class="col my-3">
            <div class="img-preview mx-auto shadow rounded bg-success" ><img src="{{$image->temporaryUrl}}" alt=""></div>
            <button type="button" class="btn btn-danger shadow d-black text-center mt-2 mx auto" wire:click="removeImage({{$key}})">Cancella</button>
          </div>
          @endforeach
        </div>
      </div>
    ...
    <div class="mb-3">
      <label for="temporary_images" class="form-label @error('temporary_images') is-invalid @enderror">Immagini</label>
      <input wire:model.lazy='temporary_images' type="file" multiple class="form-control" id="temporary_images" placeholder="seleziona immagine">
